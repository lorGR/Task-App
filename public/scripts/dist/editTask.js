...
function handleAddTask(event) {
    return __awaiter(this, void 0, void 0, function () {
        var taskId, userId, newTaskName, data, tasks, error, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    newTaskName = event.target.taskName.value;
                    console.log(newTaskName);
                    return [4 /*yield*/, axios.patch('/tasks/edit-task', { newTaskName: newTaskName, taskId: taskId })];
                case 1:
                    data = (_a.sent()).data;
                    if (!data)
                        throw new Error("Couldn't recieve data from axios PATCH URL: *** /tasks/edit-task ***");
