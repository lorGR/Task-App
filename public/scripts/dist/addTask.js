...
function handleAddTask(event) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, taskName, data, tasks, error, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios.post('/tasks/add-task', { taskName: taskName, userId: userId })];
                case 1:
                    data = (_a.sent()).data;
                    if (!data)
                        throw new Error("Couldn't receive data from axios POST URL: *** /tasks/add-task ***");
